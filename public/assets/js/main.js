(function ($) {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown($finalDate, function (event) {
            $this.html(event.strftime('<div class="count"><span class="amount">%-D</span><span class="period">დღე</span></div><div class="count"><span class="amount">%-H</span><span class="period">საათი</span></div><div class="count"><span class="amount">%-M</span><span class="period">წუთი</span></div><div class="count"><span class="amount">%-S</span><span class="period">წამი</span></div>'));
        });
    });
